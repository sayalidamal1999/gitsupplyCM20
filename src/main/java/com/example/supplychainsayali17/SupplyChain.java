...
public class SupplyChain extends Application {
    ...
    Label costumerEmailLabel = null;
    String costumerEmail=null;
    ...
    private GridPane headerBar(){
        ...
        globalLoginButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
               ...
               // costumerEmailLabel.setText("Welcome: "+ costumerEmail);
            }
        });
        costumerEmailLabel = new Label("Welcome User");
        ...
        gridPane.add(costumerEmailLabel,3,0);
    ...
    private GridPane loginPage(){
        ...
        loginButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
              ...
              //  messageLabel.setText(email + " $$" + password);
               if(login.costumerLogin(email,password)){
        ...
        gridPane.setAlignment(Pos.CENTER);
         ...
         //first is x-coordinate and second is y-coordinate
    ...
    private GridPane footerBar(){
        ...
        buyNowButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
               ...
               if(Order.placeOrder(costumerEmail,selectedProduct)){
